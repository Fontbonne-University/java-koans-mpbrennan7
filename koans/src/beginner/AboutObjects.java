...
public class AboutObjects {
    ...
    public void objectToString() {
        ...
        assertEquals(expectedToString, "java.lang.Object@"+Integer.toHexString(object.hashCode())); // hint: object.toString()  //Not sure if this is a legal move
    }
    ...
    public void toStringConcatenates() {
        ...
        assertEquals(string + object, "haha"); //overrode the toString in Object, so printing object -> ha
    }
