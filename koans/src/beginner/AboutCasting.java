...
public class AboutCasting {
    ...
    public void downcastWithInheritance() {
        ...
        Parent parentReference = (Parent) child; // Why do we need an explicit cast here? To change the instance of the object
    ...
    public void downcastAndPolymorphism() {
        Grandparent child = new Child();
        Parent parent = (Child) child; //reference is a parent, but instance is a child
